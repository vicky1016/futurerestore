...
curl -sO https://cdn.cryptiiiic.com/deps/static/Linux/x86_64/Linux_x86_64_1741248292_Release.tar.zst &
curl -sO https://cdn.cryptiiiic.com/deps/static/Linux/x86_64/Linux_x86_64_1741248292_Debug.tar.zst &
...
tar xf Linux_x86_64_1741248292_Release.tar.zst -C ${DEP_ROOT}/Linux_x86_64_Release &
tar xf Linux_x86_64_1741248292_Debug.tar.zst -C ${DEP_ROOT}/Linux_x86_64_Debug &
